...
export default function Footer({next,prev,nextName,prevName}:{next?:string;prev?:string;nextName?:string;prevName?:string}){
    return(
      <div className=" h-[10vh] mt-10 w-full flex justify-between items-center ml-[1rem] lg:ml-auto lg:px-4 py-2 ">
        { !!prev && <Link href={prev} className=" lg:px-3 py-2 group " >
        ...
        { !!next && <Link href={next} className=" lg:px-3 py-2 group " >
